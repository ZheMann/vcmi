...
if __name__ == "__main__":
    images_per_device = Path('/data/s3523799/vbdi/datasets/Exp.III/balanced_ds_28D/test/')
    patches_per_device = Path('/data/s3523799/vbdi/datasets/Exp.III/patches_ds_28D/test/')
