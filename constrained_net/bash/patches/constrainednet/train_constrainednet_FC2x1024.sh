...
#SBATCH --job-name=Exp.IV_ConstrCNN_FC2x1024_28D_patches
...
python3 ../../../src/signature/train.py --dataset="Exp.2/balanced_patches_ds_28D/" --epochs=30 --batch_size=64 --constrained=1 --model_name="ConstrainedNet_FC2x1024_28D_patches" --height=128 --width=128
