...
python3 ../../../predict/predict_flow.py --input_dir="/data/s3523799/vbdi/models/ConstrainedNet_FC2x1024_28D_patches/" --constrained=1 --dataset="Exp.2/balanced_patches_ds_28D/" --batch_size=64 --height=128 --width=128
